    ...
    return (
        <DashboardLayout activeNav="dashboard">
            ...
            >
                ...
                {/* Table Wrapper */}
                <motion.div variants={itemVariants} className="bg-white dark:bg-slate-900 rounded-b-2xl border border-gray-100 dark:border-slate-800/70 shadow-lg overflow-hidden flex flex-col mb-10 w-[25rem] md:w-[50rem] lg:w-full mt-7">
