...
import { MdArrowBack, MdShoppingCart, MdStore, MdPayment, MdLock } from 'react-icons/md';
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                >
                    ...
                    <div className="flex items-center justify-center gap-2 mb-6">
                        ...
                        <span className="text-sm text-gray-600 dark:text-slate-400">Secure SSL Encrypted Payment</span>
                    </div>
                    ...
                    <div className="border-t border-gray-200 dark:border-slate-700 pt-4 space-y-3">
                        ...
                        <div className="flex justify-between text-sm">
                            <span className="text-gray-600 dark:text-slate-400">Tax (7.5%)</span>
                            <span className="font-medium text-gray-900 dark:text-white">
